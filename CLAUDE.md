...
- Phase 5D staging resource runbook does not approve Vercel project creation, Neon database creation, secrets, deployment, database commands, live auth, UI saves or production writes.
