...
- Vercel + Neon is accepted as the hosting/database direction after Phase 5B, but provisioning, deployment, live auth, UI saves and production writes remain blocked until explicit approval.
- Phase 5C staging setup templates do not approve Vercel project creation, Neon database creation, secrets, deployment, live auth, UI saves or production writes.
