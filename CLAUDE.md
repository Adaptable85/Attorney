...
- Vercel + Supabase Postgres is accepted as the hosting/database direction after ADR 0010. ADR 0010 supersedes the Neon database-provider part of ADR 0009, but provisioning, deployment, live auth, UI saves and production writes remain blocked until explicit approval.
